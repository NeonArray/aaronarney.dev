        ...
        <Layout>
            <main data-grid-area="main" style={{ marginTop: '75px' }}>
                ...
                <div style={{ textAlign: 'center', maxWidth: '920px', margin: '0 auto', padding: '0 0.5em' }}>
                    ...
                    <p>I built this using <a className="link" href="https://www.gatsbyjs.org" target="_blank" rel="noopener nofollow noreferrer">Gatsby</a> and Tailwind. You can also take a look at the <a className="link" href="https://github.com/ocularrhythm/ocular-rhythm-site" target="_blank" rel="noopener nofollow noreferrer">source code</a> if you like, though prepare to be unimpressed. I am going to rebuild this site from the ground-up in the coming weeks (bet on it).</p>
                </div>
            </main>
        </Layout>
    );
