    ...
    plugins: [
        ...
        },
        {
            ...
            options: {
                headers: {
                    '/*': [
                        'Content-Security-Policy: default-src \'self\'; script-src \'self\' \'unsafe-inline\' \'http://ec2-54-173-166-214.compute-1.amazonaws.com\'; connect-src \'self\'; img-src https://*.ocular-rhythm.io data:; style-src \'self\' \'unsafe-inline\';',
